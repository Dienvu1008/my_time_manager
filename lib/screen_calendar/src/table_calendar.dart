...
class TableCalendar<TimeInterval> extends StatefulWidget {
  ...
  final CalendarBuilders<TimeInterval> calendarBuilders;
  ...
  final List<TimeInterval> Function(DateTime day)? eventLoader;
  ...
  @override
  _TableCalendarState<TimeInterval> createState() => _TableCalendarState<TimeInterval>();
}
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
            ...
            dowBuilder: (BuildContext context, DateTime day) {
              ...
              if (dowCell == null) {
                final weekdayString = widget.daysOfWeekStyle.dowTextFormatter
                        ...
                        ?.call(day, Localizations.localeOf(context)) ??
            ...
            markerWidget = PositionedDirectional(
              ...
              child: Row(
                ...
                children: events
                    ...
                    .map((event) => _buildSingleMarker(day, event as TimeInterval, markerSize))
                    .toList(),
              ),
            );
          }
  ...
  Widget _buildSingleMarker(DateTime day, TimeInterval event, double markerSize) {
    return widget.calendarBuilders.singleMarkerBuilder
            ?.call(context, day, event as T) ??
        Container(
          ...
          BoxDecoration(
      color: event.color ?? Color.fromARGB(255, 190, 8, 8),
