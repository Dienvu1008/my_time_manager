...
class CalendarStyle {
  ...
  //final TimeInterval _timeIntervals;
  ...
  const CalendarStyle({
    ...
    this.withinRangeTextStyle = const TextStyle(fontSize: 12,),
    this.withinRangeDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.outsideTextStyle = const TextStyle(fontSize: 12,color: const Color(0xFFAEAEAE)),
    this.outsideDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.disabledTextStyle = const TextStyle(fontSize: 12,color: const Color(0xFFBFBFBF)),
    this.disabledDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.holidayTextStyle = const TextStyle(fontSize: 12,color: const Color(0xFF5C6BC0)),
    ...
    this.weekendTextStyle = const TextStyle(fontSize: 12,color: const Color(0xFF5A5A5A)),
    ...
    this.defaultTextStyle = const TextStyle(fontSize: 12),
