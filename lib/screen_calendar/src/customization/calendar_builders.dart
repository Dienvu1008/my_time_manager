...
typedef SingleMarkerBuilder<TimeInterval> = Widget? Function(
    BuildContext context, DateTime day, TimeInterval event);

/// Signature for a function that creates an event marker for a given `day`.
/// Contains a list of `events` associated with that `day`.
typedef MarkerBuilder<TimeInterval> = Widget? Function(
    BuildContext context, DateTime day, List<TimeInterval> events);
...
class CalendarBuilders<TimeInterval> {
  ...
  final SingleMarkerBuilder<TimeInterval>? singleMarkerBuilder;
  ...
  final MarkerBuilder<TimeInterval>? markerBuilder;
