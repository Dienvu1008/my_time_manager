...
import 'package:my_time_manager/screen_calendar/component_widgets/filled_cell.dart';
import 'package:my_time_manager/screen_calendar/component_widgets/header_style.dart';
import 'package:my_time_manager/screen_calendar/component_widgets/page_header_month.dart';
...
import 'package:my_time_manager/screen_calendar/component_widgets/weekday_tile.dart';
...
class MonthViewState<T extends Object?> extends State<MonthView<T>> {
  ...
  //       date, List<TimeInterval> events, isToday, isInMonth) {
  //   return FilledCell<T>(
  //     date: date,
  ...
  Widget _defaultCellBuilder(
        date, List<TimeInterval> timeIntervals, isToday, isInMonth) {
    Color backgroundColor = Theme.of(context).colorScheme.background;
    Color offColor = Theme.of(context).brightness == Brightness.dark ? Constants.offBlack : Constants.offWhite;
    return FilledCell<T>(
      date: date,
      shouldHighlight: isToday,
