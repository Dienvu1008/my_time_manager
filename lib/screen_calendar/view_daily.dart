...
import 'package:my_time_manager/screen_calendar/component_widgets/page_header_day.dart';
import 'package:my_time_manager/screen_calendar/component_widgets/default_timeline_mark.dart';
...
import 'package:my_time_manager/screen_calendar/page_single_day_view.dart';
...
class DayView<T extends Object?> extends StatefulWidget {
  ...
  /// User can define custom event arranger by implementing [TimeIntervalsArranger]
...
class DayViewState<T extends Object?> extends State<DayView<T>> {
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return ValueListenableBuilder(
                        ...
                        builder: (_, __, ___) => SingleDayViewPage<T>(
                          key: ValueKey(
  ...
  Future<void> animateToEvent(TimeInterval event,
      {Duration? duration, Curve? curve}) async {
    await animateToDate(event.startDate!, duration: duration, curve: curve);
    await _scrollConfiguration.setScrollEvent(
      event: event,
      duration: duration ?? widget.pageTransitionDuration,
      curve: curve ?? widget.pageTransitionCurve,
